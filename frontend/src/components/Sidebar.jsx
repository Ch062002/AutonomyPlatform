function Sidebar() {
  const activeControlItem = "Research Dashboard";
  const menuItems = [
    { label: "Dashboard" },
    { label: "Telemetry" },
    { label: "Navigation" },
    ...
    {
      label: "Control",
      subItems: ["PID", "Adaptive PID", "LPV", "LQR", "SMC", "MPC", "Robust MPC", "Tube MPC", "Comparison", "Robustness Testing", "Benchmarking", "Gain Scheduling", "Research Dashboard"]
    },
    { label: "Commands" },
    { label: "Mission" },
    { label: "Maps" },
